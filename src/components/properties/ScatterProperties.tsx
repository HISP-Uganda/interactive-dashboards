...
// console.log("::::::::::::::check::::::::::",visualizationData[visualization.id][0]);
// console.log("::::::::::::::check 2::::::::::",visualization);
// console.log("::::::::::::::check 2::::::::::",visualization);
...
//                 value={columns.find(
//                     (pt) => pt.value === visualization.properties["x"]
//                 )}
//                 onChange={(e) =>
//                     changeVisualizationProperties({
//                         visualization: visualization.id,
...
//             <Select<Option, false, GroupBase<Option>>
//                 value={columns.find(
//                     (pt) => pt.value === visualization.properties["y"]
//                 )}
//                 onChange={(e) =>
//                     changeVisualizationProperties({
//                         visualization: visualization.id,
...
//                     if (
//                         visualization.properties["marker.color"] &&
//                         isArray(visualization.properties["marker.color"])
//                     ) {
//                         return (
//                             visualization.properties["marker.color"].join(
//                                 ","
//                             ) === pt.value
//                         );
//                     }
...
//             <Input
//                 value={visualization.properties["marker.size"]}
//                 onChange={(e: ChangeEvent<HTMLInputElement>) =>
//                     changeVisualizationProperties({
//                         visualization: visualization.id,
